<x-app-layout>
    ...
    {{-- Judul Halaman --}}
    <x-slot name="title">Data Pengajuan Ibadah</x-slot>

    {{-- Bagian Pengajuan Ibadah --}}
        ...
        <div class="bg-gray-50 rounded-lg border border-gray-300 shadow">
            <div class="p-2 space-y-2">
                <div class="flex flex-col lg:flex-row items-center justify-end gap-4">
                    ...
                    {{-- Form Filter & Search --}}
                    <form method="GET" action="{{ route('dashboard.request-worship.index') }}"
                        ...
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="p-2 whitespace-nowrap">
                                <div class="flex justify-center items-center gap-2">
                                    <a href="{{ route('dashboard.request-worship.edit', $worship->id) }}"
                                        class="text-yellow-600 hover:underline text-sm">Edit</a>
                                    <form action="{{ route('dashboard.request-worship.destroy', $worship->id) }}"
